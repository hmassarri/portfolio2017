    ...
    <main>
        ...
        <div class="container">
            ...
            <div class="row valign-wrapper">
                ...
                <div class="col s12 m6 l7 valign-wrapper left-align hide-on-small-only">
                    <nav class="z-depth-0">
                        <div class="nav-wrapper white">
                            <div class="col s12">
                                <a id="print" href="#print" class="breadcrumb subheader">Print</a>
                                <a id="webLink" href="#web" class="breadcrumb subheader">Web</a>
                                <!-- <a id="garageLink" href="#garage" class="breadcrumb subheader">Garage</a> -->
                            </div>
                        </div>
                    </nav>
                </div>
            ...
            <!-- Row 1 -->
            <div class="row">
                <div class="col s12 m12 l12 gap-medium">
                    <a id="web">&nbsp;</a>
                </div>
                <div class="col s12 m12 l12">
